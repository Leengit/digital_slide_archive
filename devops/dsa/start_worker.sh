...
su $(id -nu ${DSA_USER%%:*}) -c "
  ...
  DOCKER_CLIENT_TIMEOUT=86400 TMPDIR=${TMPDIR:-/tmp} HF_HOME=/root/.cache/huggingface GW_DIRECT_PATHS=true python -m girder_worker --concurrency=${DSA_WORKER_CONCURRENCY:-2} -Ofair --prefetch-multiplier=1
"
